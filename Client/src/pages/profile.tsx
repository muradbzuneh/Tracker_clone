...
const ProfilePage = () => {
  const { allActivityLogs, user, logout, fetchUser } = useAppContext();
  ...
  const handleSave = async () => {
    try {
      await mockApi.user.update(user?.id || "", formData as Partial<UserData>);
  ...
  const totalFoodEntries = allActivityLogs?.length || 0;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-sm text-gray-400">Your Profile</h3>
          ...
          {isEditing ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  variant="primary"
                  className="flex-1 bg-emerald-500 text-black"
                  onClick={handleSave}
                >
                  Save Changes
                </Button>
